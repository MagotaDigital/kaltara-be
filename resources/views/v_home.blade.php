                ...
                <div class="section-hero w-100">
                    ...
                    <section>
                        ...
                        <div class="section-hero">
                            <div
                                class="swiper-container rounded overflow-hidden swiper-container-initialized swiper-container-horizontal">
                                <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                                    <div class="swiper-slide swiper-slide-active"
                                        style="margin-right: 16px;width: fit-content !important;">
                                        <a href="/pencarian?q=Masjid%20Al%20Jabbar"
                                            class="btn-fill-white rounded d-flex align-items-center justify-content-between"
                                            style="min-width: 182px; height: 54px; padding-left: 14px; padding-right: 14px; margin-top: auto;">
                                            <p class="text-trend">
                                                Masjid Al Jabbar
                                            </p>
...
<section class="position-relative pb-5" style="top: -12rem; margin-bottom: -12rem; z-index: 99;">
    <div class="container mx-auto px-3">
        <div class="w-100 h-100 p-3 bg-white rounded shadow gap-4">
            <div class="row">
                            ...
                            <div class="col-12 col-lg-7">
                                <div class="w-100 rounded overflow-hidden" style="height: 536px;">
                                    <div class="h-100 overflow-hidden position-relative">
                                        <div class="h-100">
                                            <div class="h-100"
                                                data-src="https://dvgddkosknh6r.cloudfront.net/live/media/img/1701866939-188cc456-9dd4-4cf4-8231-f22ba6ff32b9.jpeg"
                                                lazy="loaded"
                                                style="background-position: center; background-repeat: no-repeat; background-size: cover; background-image: url(https://dvgddkosknh6r.cloudfront.net/live/media/img/1701866939-188cc456-9dd4-4cf4-8231-f22ba6ff32b9.jpeg);">
                                            </div>
                                            <div class="visible d-inline-block  position-absolute bottom-0 bg-dark bg-opacity-50 rounded px-3 py-4 text-white"
                                                style="backdrop-filter: blur(8px); height: 62%;">
                                                <div class="d-flex flex-column h-100">
                                                    <div class="d-md-none d-flex align-items-center justify-content-between py-2 px-3 rounded bg-white bg-opacity-50 mb-4"
                                                        ...
                                                        <p class="text-white" data-v-47d3243a=""><span
                                                                class="fw-bold ms-1" data-v-47d3243a="">
                                                                1
                                                            </span>
                                                            dari 5
                                                        </p> <button aria-label="Berita Selanjutnya"
                                                            class="btn btn-sm btn-secondary bg-secondary bg-opacity-10"
                                                            data-v-47d3243a="">
                                                            <div aria-hidden="true"
                                                                class="d-flex justify-content-center align-items-center"
                                                    ...
                                                    <div class="flex-grow-0">
                                                        <p class="font-roboto opacity-75 mb-1">
                                                            ...
                                                            href="/berita/bey-machmudin-lantik-eti-herawati-sebagai-wali-kota-cirebon-11671"
                                                            class="">
                                                            <h2
                                                                class="text-truncate-3 font-intro fw-bold text-white mb-3">
                                                                Bey Machmudin Lantik Eti Herawati sebagai Wali Kota
                                                                Cirebon
                                                            </h2>
                                                        </a>
                                                        <div
                                                            ...
                                                            <p class="d-flex align-items-center gap-2"
                                                                ...
                                                                <span>Rabu, 6 Desember 2023</span>
                                                            </p>
                                                            <p class="ps-2 d-flex align-items-center gap-1 capitalize"
                                                                style="font-size: 12px;">
                                                                <img src="images/icons/pen.svg" width="16px"
                                                                    height="16px" aria-hidden="true">
                                                                <span class="text-truncate">Penulis : RILIS
                                                                    HUMAS</span>
                                                            </p>
                                                        </div>
                                                        <div
                                                            class="d-md-flex justify-content-between align-items-center">
                                                            <a href="/berita/bey-machmudin-lantik-eti-herawati-sebagai-wali-kota-cirebon-11671"
        ...
        <div class="swiper mySwiper-Banner">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="w-100 ratio ratio-21x9 rounded overflow-hidden">
                        <a href="https://sapawarga.digitalservice.id/" target="_blank" rel="noopener" title="Sapawarga">
                            <picture>
                                <img src="https://dvgddkosknh6r.cloudfront.net/live/media/img/1687854658-banner-sapawarga.jpg"
                                    alt="Sapawarga" width="360" height="120" class="w-100 h-100"
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="list-card list-type gap-4 p-4 rounded ease-brand duration-250" style="height: 253px;">
                        ...
                        <a href="https://saberhoaks.jabarprov.go.id/v2/home" target="_blank" rel="noreferrer">
                            <h3 class="fw-bold mt-3">
                                Jabar Saber Hoaks
                            </h3>
                        </a>
                        <p class="text-truncate-3 mt-2">
                            Unit kerja di bawah Pemdaprov Jabar yang membantu proses verifikasi informasi atau
                            rumor
                            yang beredar di masyarakat untuk menghadirkan informasi yang akurat dan terpercaya.
                        </p>
                        <a href="https://saberhoaks.jabarprov.go.id/v2/home" target="_blank" rel="noreferrer"
