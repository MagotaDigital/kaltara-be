        ...
        <section class="position-relative w-100"
            ...
            <div class="container mx-auto px-5 position-relative pt-24 pb-40 z-10"
                ...
                <h3 class="font-lora fw-bold text-white">
                    Daftar Layanan Kependudukan dan Tempat Tinggal
                </h3>
                <div>
                    <h6 class="font-lato fw-normal text-white line-clamp-3">
                        Lihat berbagai layanan untuk kebutuhan seputar kependudukan dan tempat tinggal
                    </h6>
                </div>
            </div>
        </section>
            ...
            <div class="container mx-auto px-5 position-relative -top-24" style="top: -6rem;z-index: 20;">
                <div class="p-3 py-4 rounded bg-white d-flex flex-column gap-4" style="min-height: 377px;">
                    <form
                        ...
                        <input type="text" aria-label="Kolom Pencarian" class="w-100 flex-grow-0 input-hero" value=""
                            style="border: none; min-width: 0;">
                    </form>
                    <section>
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="list-card gap-4 p-4 rounded ease-brand duration-250" style="height: fit-content;">
                                    <img src="https://dvgddkosknh6r.cloudfront.net/live/media/img/1690280849-Logo.png"
                                        width="32" height="32" alt="Jabar Saber Hoaks" class="lazy-img" lazy="loaded">
                                    <a href="https://saberhoaks.jabarprov.go.id/v2/home" target="_blank"
                                        rel="noreferrer">
